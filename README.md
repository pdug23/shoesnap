...
Drag-and-drop shoe images, cut them out with AI, and export polished, web-ready WebP files — perfect for shoe cards, product catalogs, and comparison apps.

## Features

- **Drag-and-drop** — Drop images (PNG, JPG, WEBP, AVIF, TIFF, BMP) for one-by-one background removal with custom naming
...
shoesnap/
├── main.py                 # Entry point
├── shoe_processor.py       # Drag-and-drop background removal GUI
